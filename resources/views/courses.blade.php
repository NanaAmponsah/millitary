            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div style="float:right;">
                        <div class="form-group">
                            <select class="form-control" id="sel1" name="action" style="width: 200px;" onchange="submit()">
                                ...
                                <option value="Courses"> Nominate Courses</option>
                                <option value="Remove course">Remove Nomination</option>
                            </select>
                        </div>
                        <noscript>
                    ...
                    <table class="table table-hover dataTable table-striped width-full" data-plugin="dataTable">
                        ...
                        @foreach($personnel_courses as $person)
                            <tr>
                                ...
                                <td>
                                    @if($person->nominated_for_course =='1')
