...
@section('content')
    <div class="page animsition">
        <div class="page-header">
            <h1 class="page-title">List of Personnel (Promotion Status)</h1>
            <ol class="breadcrumb">
                <li><a href="{{ url('/') }}">Home</a></li>
                <li class="active">List of Personnel (Promotion Status)</li>
            </ol>
        </div>
                    ...
                    {{--<div style="float:right;">--}}
                        {{--<div class="form-group">--}}
                            {{--<select class="form-control" id="sel1" name="action" style="width: 200px;" onchange="submit()">--}}
                                ...
                                {{--<option value="Promote">Promote Personel</option>--}}
                                {{--<option value="Undo_promote">Undo</option>--}}
                            {{--</select>--}}
                        {{--</div>--}}
                        {{--<noscript>--}}
