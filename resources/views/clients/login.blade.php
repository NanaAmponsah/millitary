...
<div class="page animsition vertical-align text-center" data-animsition-in="fade-in"
    ...
    <div class="page-content vertical-align-middle">
        ...
        <p>Sign in</p>
        {!!  Form::open(array('url'=>'clients/login','method'=>'POST'))  !!}
        <div class="form-group">
            <label class="sr-only" >Service Number</label>
            {!! Form::text('serviceno','',array('class'=>'form-control','placeholder'=>'Enter Service Number')) !!}
